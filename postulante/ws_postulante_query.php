...
$sql = 'SELECT IDPOSTULANTE, IDGENERO, IDTIPODOCUMENTO, IDUSUARIO, NOMBREPOSTULANTE, APELLIDOPOSTULANTE, FECHANAC, DUI, NIT, DIRECCION, CORREO FROM POSTULANTE WHERE IDUSUARIO = ? LIMIT 1';
