-- =============================================================================
-- ESQUEMA COMPLETO - Bolsa de Trabajo PDM (base NUEVA o vacia)
--
-- Si YA tienes datos (Usuario, CERTIFICACION, etc.) NO uses este para "resetear".
-- En ese caso ejecuta: actualizar_esquema_sin_perder_datos.sql
--
-- Este archivo: CREATE TABLE IF NOT EXISTS (no borra datos existentes)
-- DBeaver: Ctrl+A -> Ctrl+Alt+X
-- =============================================================================
...
-- Verificacion: debe listar 24 tablas
